...
create table if not exists public.notifications (
  ...
  type text not null check(type in ('like','comment','follow','review')),
...
drop trigger if exists shelves_touch_updated_at on public.shelves;
create trigger shelves_touch_updated_at before update on public.shelves for each row execute procedure public.touch_updated_at();
